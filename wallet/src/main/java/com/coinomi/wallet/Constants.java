...
import com.coinomi.core.coins.ElementMain;
...
public class Constants {
    ...
    public static final String BINARY_URL = "https://github.com/Crypto-city/Element-HYP-Android/releases";

    public static final String VERSION_URL = "/version";
    public static final String PARTNERS_URI = "/partner.json";
    public static final String SUPPORT_EMAIL = "info@element-hyp.com";

    // TODO move to resource files
    public static final List<CoinAddress> DEFAULT_COINS_SERVERS = ImmutableList.of(
            new CoinAddress(ElementMain.get(), new ServerAddress("element-electrum.org", 33001),
                    new ServerAddress("element-electrum.org", 33001))
    ...
    static {
        ...
        COINS_ICONS.put(CoinID.ELEMENT_MAIN.getCoinType(), R.drawable.element);


        COINS_BLOCK_EXPLORERS = new HashMap<>();
        COINS_BLOCK_EXPLORERS.put(CoinID.ELEMENT_MAIN.getCoinType(), "https://chainz.cryptoid.info/hyp/");
    }
