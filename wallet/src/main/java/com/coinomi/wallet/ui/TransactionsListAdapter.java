...
//        final boolean isInternal = WalletUtils.isInternal(tx);
        ...
        // confidence
        rowDirectionFontIcon.setTextColor(Color.parseColor("#FFA4EED8"));
...
//                rowDirectionFontIcon.setBackgroundResource(R.drawable.transaction_row_circle_bg_send);
                rowValue.setTextColor(res.getColor(R.color.hyp_grey));
            } else {
...
//            rowDirectionFontIcon.setBackgroundResource(R.drawable.transaction_row_circle_bg_pending);
        ...
        if (tx.getDepthInBlocks() < 4) {
            ...
            rowConfirmationsFontIcon.setTextColor(R.color.hyp_grey);
        ...
        if (tx.isGenerated()) {
            ...
            rowDirectionText.setTextColor(Color.parseColor("#FFA4EED8"));
        ...
        if (time > 0) {
            ...
            rowDate.setTextColor(Color.parseColor("#FFA4EED8"));
        ...
        if (label != null) {
            ...
            rowLabel.setTextColor(Color.parseColor("#14d199"));
            rowAddress.setVisibility(View.GONE);
        } else {
        ...
        rowValue.setTextColor(Color.parseColor("#14d199"));
